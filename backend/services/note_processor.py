...
class NoteProcessorService:
    ...
    async def process_note(self, note_id: uuid.UUID):
        """Processes the PDF note: extracts text, cleans it, chunks it, generates embeddings, and indexes it."""
        ...
        try:
            ...
            await self.note_repo.update(note)
            ...
            await self.note_repo.create_metadata(meta)
